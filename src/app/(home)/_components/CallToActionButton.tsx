const CallToActionButton = () => {
	return <button className="uppercase bg-primary w-[313px] h-[40px] rounded-[10px] text-[20px] font-bold my-6 pl-[2px] flex items-center justify-center gap-[10px] leading-[100%] px-10 py-2 ">GET STARTED  <RightArrowIcon/></button>;
};
...
const RightArrowIcon = ()=><svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" viewBox="0 0 8 14" fill="none">
